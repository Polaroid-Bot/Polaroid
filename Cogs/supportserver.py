...
class supportserver(commands.Cog):
    ...
    async def stats(self, ctx):
        ...
        if ping < 200:
            ...
            color = 0xf7220f
        pEmbed = discord.Embed(title=f"Stats", color=color)
        ...
        pEmbed.add_field(name="Uptime", value=f"Taking photos for {days}d, {hours}h, {minutes}m in {len(self.bot.guilds)} servers.", inline=False)
